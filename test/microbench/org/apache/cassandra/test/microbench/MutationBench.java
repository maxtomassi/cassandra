...
public class MutationBench
{
    ...
    {
        String tableName = "userpics";

        doSchemaChanges(
            createKeyspace(keyspace),
            createTable(CreateTableStatement.parse("CREATE TABLE " + tableName +" ("+
                                                   "userid bigint," +
                                                   "picid bigint," +
                                                   "commentid bigint, " +
        ...
        TableMetadata metadata = SchemaManager.instance.getTableMetadata(keyspace, tableName);
