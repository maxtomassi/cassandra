    ...
    public static class Builder
    {
        ...
        public CQLSSTableWriter build()
        {
            ...
            synchronized (CQLSSTableWriter.class)
            {
                ...
                SchemaManager.instance.apply(SchemaTransformations.createKeyspaceIfNotExists(ksToCreate)).join();

                Types typesToCreate = createTypes(keyspaceName);
                SchemaManager.instance.apply(SchemaTransformations.createTypesIfNotExists(typesToCreate)).join();

                TableMetadata tableMetadata = createTable(typesToCreate);
                SchemaManager.instance.apply(SchemaTransformations.createTableIfNotExists(tableMetadata)).join();
