...
final class SchemaDiagnostics
{
    ...
    static void keyspaceAltering(SchemaManager schemaManager, KeyspaceMetadata.Diff delta)
    {
    ...
    static void keyspaceAltered(SchemaManager schemaManager, KeyspaceMetadata.Diff delta)
    {
